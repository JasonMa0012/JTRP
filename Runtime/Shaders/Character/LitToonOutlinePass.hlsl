...
VertexOutput vert(VertexInput v)
{
    ...
    float outlineWidth = _Outline_Width * v.color.g * GetOutLineScale(distance);
    
	posWS += outlineWidth * 0.03 * _BakedNormalDir;
	o.pos = TransformWorldToHClip(posWS);
	o.pos.z = LinearEyeDepthToOutDepth(LinearEyeDepth(o.pos.z) + _Offset_Z * v.color.r);
...
float4 frag(VertexOutput i): SV_Target
{
    ...
    return float4(Set_BaseColor, 1.0);
}
