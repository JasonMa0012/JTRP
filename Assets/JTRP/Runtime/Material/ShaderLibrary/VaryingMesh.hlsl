...
#endif
#ifdef ATTRIBUTES_NEED_TEXCOORD4
    float2 uv4          : TEXCOORD4;
#endif
#ifdef ATTRIBUTES_NEED_TEXCOORD5
    float2 uv5          : TEXCOORD5;
#endif
#ifdef ATTRIBUTES_NEED_TEXCOORD6
    float2 uv6          : TEXCOORD6;
#endif
#ifdef ATTRIBUTES_NEED_TEXCOORD7
...
#elif defined(VARYINGS_NEED_TEXCOORD4)
    float2 interpolators5 : TEXCOORD5;
#endif

#ifdef VARYINGS_NEED_TEXCOORD6
    float4 interpolators6 : TEXCOORD6;
#elif defined(VARYINGS_NEED_TEXCOORD7)
    float2 interpolators6 : TEXCOORD6;
#endif

#ifdef VARYINGS_NEED_COLOR
    float4 interpolators5 : TEXCOORD7;
#endif
...
#endif
#ifdef VARYINGS_NEED_TEXCOORD4
    output.interpolators5.xy = input.texCoord4;
#endif
#ifdef VARYINGS_NEED_TEXCOORD5
    output.interpolators5.zw = input.texCoord5;
#endif
#ifdef VARYINGS_NEED_TEXCOORD6
    output.interpolators6.zw = input.texCoord6;
#endif
#ifdef VARYINGS_NEED_TEXCOORD7
    output.interpolators6.xy = input.texCoord7;
#endif
...
#endif
#ifdef VARYINGS_NEED_TEXCOORD1
    output.texCoord0.zw = input.interpolators3.zw;
#endif
#ifdef VARYINGS_NEED_TEXCOORD2
    output.texCoord1.xy = input.interpolators4.xy;
#endif
#ifdef VARYINGS_NEED_TEXCOORD3
    output.texCoord1.zw = input.interpolators4.zw;
#endif
#ifdef VARYINGS_NEED_TEXCOORD4
    output.texCoord2.xy = input.interpolators5.xy;
#endif
#ifdef VARYINGS_NEED_TEXCOORD5
    output.texCoord2.zw = input.interpolators5.zw;
#endif
#ifdef VARYINGS_NEED_TEXCOORD6
    output.texCoord3.xy = input.interpolators6.zw;
#endif
#ifdef VARYINGS_NEED_TEXCOORD7
    output.texCoord3.zw = input.interpolators6.xy;
#endif
#ifdef VARYINGS_NEED_COLOR
